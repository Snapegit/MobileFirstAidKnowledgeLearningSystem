		...
		<el-dialog v-model="formVisible" :title="formTitle" width="80%" destroy-on-close :fullscreen='false'>
			<el-form class="formModel_form" ref="formRef" :model="form" label-width="$template2.back.add.form.base.labelWidth" :rules="rules">
				<el-row>
					...
					<el-col :span="24">
						<el-form-item label="课程分类" prop="kechengfenlei">
							<el-select
								class="list_sel"
								:disabled="!isAdd||disabledForm.kechengfenlei?true:false"
								v-model="form.kechengfenlei" 
								placeholder="请选择课程分类"
								>
								<el-option v-for="(item,index) in kechengfenleiLists" :label="item"
									:value="item"
									>
								</el-option>
							</el-select>
					...
					<el-col :span="24">
						<el-form-item label="课程内容" prop="kechengneirong">
							<el-input v-model="form.kechengneirong" placeholder="课程内容" type="textarea"
							:readonly="!isAdd||disabledForm.kechengneirong?true:false"
							/>
						</el-form-item>
					</el-col>
				</el-row>
	...
	const init=(formId=null,formType='add',formNames='',row=null,table=null,statusColumnName=null,tips=null,statusColumnValue=null)=>{
		...
		if(formType == 'add'){
			...
			for(let x in row){
				...
				if(x=='kechengfenlei'){
					form.value.kechengfenlei = row[x];
					disabledForm.value.kechengfenlei = true;
					continue;
				}
				if(x=='shipin'){
				...
				if(x=='kechengneirong'){
					form.value.kechengneirong = row[x];
					disabledForm.value.kechengneirong = true;
					continue;
				}
				if(x=='faburiqi'){

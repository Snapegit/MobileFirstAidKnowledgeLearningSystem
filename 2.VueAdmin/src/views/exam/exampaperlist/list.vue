	...
	<div>
		<div class="app-contain">
					...
					<el-form :model="searchQuery" class="search_form">
						<div class="search_view">
							...
							<div class="search_box">
								<el-input class="search_inp" v-model="searchQuery.name" placeholder="答题名称" clearable>
								</el-input>
							</div>
						</div>
			...
			<el-table v-loading="listLoading" border :stripe='true' @selection-change="handleSelectionChange" ref="table"
				...
				<el-table-column label="答题" :resizable='true' :sortable='true' align="left" header-align="center">
					<template #default="scope">
						{{scope.row.name}}
					</template>
				</el-table-column>
				<el-table-column label="考试时长(分钟)" :resizable='true' :sortable='true' align="left" header-align="center">
					<template #default="scope">
						{{scope.row.time}}
					</template>
				</el-table-column>

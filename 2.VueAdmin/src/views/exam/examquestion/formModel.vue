	...
	<div>
		<el-dialog v-model="formVisible" :title="formTitle" width="70%" destroy-on-close :fullscreen='false'>
			<el-form class="formModel_form" ref="formRef" :model="form" label-width="$template2.back.add.form.base.labelWidth" :rules="rules">
				<el-row>
					<el-col :span="24">
						<el-form-item label="答题" prop="paperid">
							<el-select class="list_sel" :disabled="!isAdd" v-model="form.paperid" placeholder="答题名称" style="width:100%"
								@change="paperChange">
					...
					<el-col :span="24">
						<el-form-item label="题库信息类型" prop="type">
							<el-select class="list_sel" :disabled="!isAdd" v-model="form.type" placeholder="题库信息类型" style="width:100%" @change="typeChange">
					...
					<el-col :span="24">
						<el-form-item label="题库信息题目" prop="questionname">
							<el-input :readonly="!isAdd" v-model="form.questionname" placeholder="题库信息题目" type="textarea"></el-input>
						</el-form-item>
					</el-col>
					<!-- 单选题 -->

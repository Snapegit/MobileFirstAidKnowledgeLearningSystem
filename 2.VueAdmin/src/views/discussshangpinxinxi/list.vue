	...
	<div>
		<div class="app-contain">
			<div class="list_search_view">
				...
				<br>
				<div class="btn_view">
					<el-button type="success" @click="addClick" v-if="btnAuth('discussshangpinxinxi','新增')">新增</el-button>
					<el-button type="primary" :disabled="selRows.length==1?false:true" @click="editClick" v-if=" btnAuth('discussshangpinxinxi','修改')">修改</el-button>
			...
			<el-table
				...
				<el-table-column label="操作" width="300" :resizable='true' :sortable='true' align="left" header-align="center">
					<template #default="scope">
						<el-button v-if="btnAuth('discussshangpinxinxi','查看评论')" type="warning" @click="commentClick(scope.row.id)">查看评论</el-button>
						<el-button type="warning" @click="replyClick(scope.row.id)">回复</el-button>
					</template>
				</el-table-column>
			</el-table>
			<el-pagination 
...
<script setup>
	...
	//基础信息
	const tableName = 'discussshangpinxinxi'
	const formName = '商品信息评论表'
	...
	const commentClick=(id)=>{
		context?.$router.push('/discussdiscussshangpinxinxi?refid=' + id)
	}
